...
'mPKEY.bas - An add-on for oleexp.tlb
'
'This module contains all PROPERTYKEY values from propkey.h in the Windows 10 SDK.
'They can be used directly, no need to convert into another form, e.g.
'IPropertyStore.GetValue PKEY_Rating, vRating
'
'NOTE: While this is a large file, only the PROPERTYKEYs that are actually used get compiled
'      into the exe. The compiler skips unused values, so usually despite the large size of
'      this module, it contributes only a few KB to the size of your exe.
'
'Specialized PROPERTYKEY values for things like Portable Devices, Core Audio, etc that are
'not found in propkey.h are found in dedicated add-on modules; this module contains only the
'propkey.h set.
'
'Last updated 6/27/2023: Added Sensor API PKEYs
'updated on 3/16/2020: Added a number of undocumented PROPERTYKEYs that don't have display names.
Private Declare Function IsEqualGUID Lib "ole32" (ByRef rguid1 As UUID, ByRef rguid2 As UUID) As Long
...
Public Function IsEqualPKEY(pk1 As PROPERTYKEY, pk2 As PROPERTYKEY) As Boolean
If pk1.pid <> pk2.pid Then Exit Function
If IsEqualGUID(pk1.fmtid, pk2.fmtid) Then
    IsEqualPKEY = True
End If
End Function
...
PKEY_Status = pkk
End Function
Public Function PKEY_StatusIcons() As PROPERTYKEY
...
Public Function PKEY_AppUserModel_IsDestListLink() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9F4C2855, CInt(&H9F79), CInt(&H4B39), &HA8, &HD0, &HE1, &HD4, &H2D, &HE1, &HD5, &HF3, 7)
PKEY_AppUserModel_IsDestListLink = pkk
End Function
Public Function PKEY_ChapterId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 19)
PKEY_ChapterId = pkk
End Function
Public Function PKEY_CheckState() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 8)
PKEY_CheckState = pkk
End Function
Public Function PKEY_Communication_NewsgroupName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9C1FCF74, CInt(&H2D97), CInt(&H41BA), &HB4, &HAE, &HCB, &H2E, &H36, &H61, &HA6, &HE4, 7)
PKEY_Communication_NewsgroupName = pkk
End Function
Public Function PKEY_Condition() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HF8245476, CInt(&H2EC6), CInt(&H44BE), &HB2, &HF7, &H82, &HEC, &H25, &H37, &HFA, &H2E, 100)
PKEY_Condition = pkk
End Function
Public Function PKEY_ConditionKey() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HF8245476, CInt(&H2EC6), CInt(&H44BE), &HB2, &HF7, &H82, &HEC, &H25, &H37, &HFA, &H2E, 101)
PKEY_ConditionKey = pkk
End Function
Public Function PKEY_ContentUrl() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H49691C90, CInt(&H7E17), CInt(&H101A), &HA9, &H1C, &H8, &H0, &H2B, &H2E, &HCD, &HA9, 10)
PKEY_ContentUrl = pkk
End Function
Public Function PKEY_ControlPanel_Category() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H305CA226, CInt(&HD286), CInt(&H468E), &HB8, &H48, &H2B, &H2E, &H8E, &H69, &H7B, &H74, 2)
PKEY_ControlPanel_Category = pkk
End Function
Public Function PKEY_ControlPanel_EnableInSafeMode() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H305CA226, CInt(&HD286), CInt(&H468E), &HB8, &H48, &H2B, &H2E, &H8E, &H69, &H7B, &H74, 3)
PKEY_ControlPanel_EnableInSafeMode = pkk
End Function
Public Function PKEY_ControlPanel_Module() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H305CA226, CInt(&HD286), CInt(&H468E), &HB8, &H48, &H2B, &H2E, &H8E, &H69, &H7B, &H74, 4)
PKEY_ControlPanel_Module = pkk
End Function
Public Function PKEY_DefaultGroupOrder() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H83914D1A, CInt(&HC270), CInt(&H48BF), &HB0, &HD, &H1C, &H4E, &H45, &H1B, &H1, &H50, 100)
PKEY_DefaultGroupOrder = pkk
End Function
Public Function PKEY_DelegateIDList() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 32)
PKEY_DelegateIDList = pkk
End Function
Public Function PKEY_DelegateSourceId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 11)
PKEY_DelegateSourceId = pkk
End Function
Public Function PKEY_DelegationFlags() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 9)
PKEY_DelegationFlags = pkk
End Function
Public Function PKEY_DuiControlResource() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HEA810849, CInt(&H87FF), CInt(&H4B54), &HAB, &HD6, &H5B, &H71, &HAD, &HF4, &H66, &HF8, 1)
PKEY_DuiControlResource = pkk
End Function
Public Function PKEY_Extensions_BlockedCount() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 5)
PKEY_Extensions_BlockedCount = pkk
End Function
Public Function PKEY_Extensions_CLSID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 6)
PKEY_Extensions_CLSID = pkk
End Function
Public Function PKEY_Extensions_DateLastUsed() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 3)
PKEY_Extensions_DateLastUsed = pkk
End Function
Public Function PKEY_Extensions_FileName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 10)
PKEY_Extensions_FileName = pkk
End Function
Public Function PKEY_Extensions_FilePath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 11)
PKEY_Extensions_FilePath = pkk
End Function
Public Function PKEY_Extensions_Flags() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 12)
PKEY_Extensions_Flags = pkk
End Function
Public Function PKEY_Extensions_Status() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 7)
PKEY_Extensions_Status = pkk
End Function
Public Function PKEY_Extensions_Suspect() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 9)
PKEY_Extensions_Suspect = pkk
End Function
Public Function PKEY_Extensions_Type() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 2)
PKEY_Extensions_Type = pkk
End Function
Public Function PKEY_Extensions_UsedCount() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F5D9B45, CInt(&H5E9F), CInt(&H4D5C), &H8A, &H5E, &H40, &H31, &H81, &HBF, &H17, &H7B, 4)
PKEY_Extensions_UsedCount = pkk
End Function
Public Function PKEY_FileAttributesDisplay() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8D72ACA1, CInt(&H716), CInt(&H419A), &H9A, &HC1, &HAC, &HB0, &H7B, &H18, &HDC, &H32, 2)
PKEY_FileAttributesDisplay = pkk
End Function
Public Function PKEY_FileIndex() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, 8)
PKEY_FileIndex = pkk
End Function
Public Function PKEY_FileReparsePointTag() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3D75E4F5, CInt(&HA391), CInt(&H4952), &H81, &HF7, &HC7, &H7, &H2F, &HE5, &H30, &H25, 100)
PKEY_FileReparsePointTag = pkk
End Function
Public Function PKEY_FilterInfo() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 2)
PKEY_FilterInfo = pkk
End Function
Public Function PKEY_ForceFullText() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1173F62A, CInt(&H2A55), CInt(&H4F62), &HAE, &HD6, &H8C, &H71, &H12, &HE0, &HF7, &HA3, 5)
PKEY_ForceFullText = pkk
End Function
Public Function PKEY_Game_HomepageTask() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 42)
PKEY_Game_HomepageTask = pkk
End Function
Public Function PKEY_Game_IntUpdateStatus() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBB44403B, CInt(&H1399), CInt(&H4650), &H95, &HEB, &H3, &HC5, &H3A, &H57, &HC2, &HCF, 60)
PKEY_Game_IntUpdateStatus = pkk
End Function
Public Function PKEY_Game_RatingDescription() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 30)
PKEY_Game_RatingDescription = pkk
End Function
Public Function PKEY_Game_RatingResourceId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 34)
PKEY_Game_RatingResourceId = pkk
End Function
Public Function PKEY_Game_RatingResourcePath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 32)
PKEY_Game_RatingResourcePath = pkk
End Function
Public Function PKEY_Game_RatingResourceType() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 33)
PKEY_Game_RatingResourceType = pkk
End Function
Public Function PKEY_Game_RatingUrl() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H26B8D54F, CInt(&H371F), CInt(&H4AEB), &H8A, &H84, &H92, &H24, &HAE, &HA4, &HD4, &HA, 35)
PKEY_Game_RatingUrl = pkk
End Function
Public Function PKEY_HasLeafContainers() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HA11C005A, CInt(&HFF95), CInt(&H4785), &H86, &H17, &HBE, &HAF, &H92, &H39, &H9C, &H3C, 100)
PKEY_HasLeafContainers = pkk
End Function
Public Function PKEY_HasNoAdditionalProperties() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H27B381E0, CInt(&H61DD), CInt(&H449C), &HB7, &H39, &H81, &H5E, &HF, &H3, &H12, &H99, 100)
PKEY_HasNoAdditionalProperties = pkk
End Function
Public Function PKEY_HideInGrepSearch() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC6F039E7, CInt(&HF6A4), CInt(&H4185), &HAE, &H48, &H7, &H93, &H82, &H62, &HC2, &H74, 100)
PKEY_HideInGrepSearch = pkk
End Function
Public Function PKEY_HideOnDesktop() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 34)
PKEY_HideOnDesktop = pkk
End Function
Public Function PKEY_History_CodePage() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 6)
PKEY_History_CodePage = pkk
End Function
Public Function PKEY_History_DateChanged() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 39)
PKEY_History_DateChanged = pkk
End Function
Public Function PKEY_History_DownloadLocation() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 10)
PKEY_History_DownloadLocation = pkk
End Function
Public Function PKEY_History_DownloadSize() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 11)
PKEY_History_DownloadSize = pkk
End Function
Public Function PKEY_History_FavoriteIconHash() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 42)
PKEY_History_FavoriteIconHash = pkk
End Function
Public Function PKEY_History_FavoriteIconKey() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 12)
PKEY_History_FavoriteIconKey = pkk
End Function
Public Function PKEY_History_Flags() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 40)
PKEY_History_Flags = pkk
End Function
Public Function PKEY_History_IconBits() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 24)
PKEY_History_IconBits = pkk
End Function
Public Function PKEY_History_IconDate() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 27)
PKEY_History_IconDate = pkk
End Function
Public Function PKEY_History_IsDownload() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 9)
PKEY_History_IsDownload = pkk
End Function
Public Function PKEY_History_IsFavorite() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 13)
PKEY_History_IsFavorite = pkk
End Function
Public Function PKEY_History_IsFeed() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 18)
PKEY_History_IsFeed = pkk
End Function
Public Function PKEY_History_IsHistory() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 8)
PKEY_History_IsHistory = pkk
End Function
Public Function PKEY_History_IsOfflineFavorite() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 14)
PKEY_History_IsOfflineFavorite = pkk
End Function
Public Function PKEY_History_IsPinnedFavorite() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 15)
PKEY_History_IsPinnedFavorite = pkk
End Function
Public Function PKEY_History_IsTopLevel() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 17)
PKEY_History_IsTopLevel = pkk
End Function
Public Function PKEY_History_IsTypedUrl() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 16)
PKEY_History_IsTypedUrl = pkk
End Function
Public Function PKEY_History_Keywords() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 19)
PKEY_History_Keywords = pkk
End Function
Public Function PKEY_History_Points() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 28)
PKEY_History_Points = pkk
End Function
Public Function PKEY_History_Sessions() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 29)
PKEY_History_Sessions = pkk
End Function
Public Function PKEY_History_SubscriptionCookie() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 33)
PKEY_History_SubscriptionCookie = pkk
End Function
Public Function PKEY_History_Tracking() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 34)
PKEY_History_Tracking = pkk
End Function
Public Function PKEY_History_UrlExtraInfo() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 5)
PKEY_History_UrlExtraInfo = pkk
End Function
Public Function PKEY_History_UrlHash() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 1)
PKEY_History_UrlHash = pkk
End Function
Public Function PKEY_History_UserDescription() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 22)
PKEY_History_UserDescription = pkk
End Function
Public Function PKEY_History_UserKeywords() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 20)
PKEY_History_UserKeywords = pkk
End Function
Public Function PKEY_History_Watch() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 41)
PKEY_History_Watch = pkk
End Function
Public Function PKEY_IconIndex() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 26)
PKEY_IconIndex = pkk
End Function
Public Function PKEY_IconPath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 25)
PKEY_IconPath = pkk
End Function
Public Function PKEY_Image_Copyright() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H14B81DA1, CInt(&H135), CInt(&H4D31), &H96, &HD9, &H6C, &HBF, &HC9, &H67, &H1A, &H99, 33432)
PKEY_Image_Copyright = pkk
End Function
Public Function PKEY_Image_PropertyBag() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H14B81DA1, CInt(&H135), CInt(&H4D31), &H96, &HD9, &H6C, &HBF, &HC9, &H67, &H1A, &H99, 40096)
PKEY_Image_PropertyBag = pkk
End Function
Public Function PKEY_IsDefaultSaveLocationForDisplay() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5D76B67F, CInt(&H9B3D), CInt(&H44BB), &HB6, &HAE, &H25, &HDA, &H4F, &H63, &H8A, &H67, 7)
PKEY_IsDefaultSaveLocationForDisplay = pkk
End Function
Public Function PKEY_IsFolder() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9329B74, CInt(&H40A3), CInt(&H4C68), &HBF, &H7, &HAF, &H9A, &H57, &H2F, &H60, &H7C, 100)
PKEY_IsFolder = pkk
End Function
Public Function PKEY_IsGroup() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC64A866E, CInt(&H41AE), CInt(&H4C8C), &HB3, &HD5, &HDD, &H6D, &HBF, &H70, &HC9, &HC1, 100)
PKEY_IsGroup = pkk
End Function
Public Function PKEY_IsSimpleItem() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H32BCB03C, CInt(&H7F34), CInt(&H4E3F), &HBB, &HB2, &HEB, &HE6, &H36, &H29, &HF5, &HE4, 100)
PKEY_IsSimpleItem = pkk
End Function
Public Function PKEY_ItemAfter() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB9B4B3FC, CInt(&H2B51), CInt(&H4A42), &HB5, &HD8, &H32, &H41, &H46, &HAF, &HCF, &H25, 6)
PKEY_ItemAfter = pkk
End Function
Public Function PKEY_ItemContext() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 25)
PKEY_ItemContext = pkk
End Function
Public Function PKEY_ItemId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 8)
PKEY_ItemId = pkk
End Function
Public Function PKEY_ItemSourceCLSID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 10)
PKEY_ItemSourceCLSID = pkk
End Function
Public Function PKEY_ItemsInStack() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 7)
PKEY_ItemsInStack = pkk
End Function
Public Function PKEY_LayoutPattern_PlaceHolder() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC9944A21, CInt(&HA406), CInt(&H48FE), &H82, &H25, &HAE, &HC7, &HE2, &H4C, &H21, &H1B, 502)
PKEY_LayoutPattern_PlaceHolder = pkk
End Function
Public Function PKEY_LibraryLocationSupportStatus() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5D76B67F, CInt(&H9B3D), CInt(&H44BB), &HB6, &HAE, &H25, &HDA, &H4F, &H63, &H8A, &H67, 9)
PKEY_LibraryLocationSupportStatus = pkk
End Function
Public Function PKEY_Link_HotKey() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 36)
PKEY_Link_HotKey = pkk
End Function
Public Function PKEY_Link_ShowCmd() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 37)
PKEY_Link_ShowCmd = pkk
End Function
Public Function PKEY_Link_WhatsNew() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 38)
PKEY_Link_WhatsNew = pkk
End Function
Public Function PKEY_Link_WorkingFolderPath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 35)
PKEY_Link_WorkingFolderPath = pkk
End Function
Public Function PKEY_ListDescription() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 23)
PKEY_ListDescription = pkk
End Function
Public Function PKEY_LocationEmptyString() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H62D2D9AB, CInt(&H8B64), CInt(&H498D), &HB8, &H65, &H40, &H2D, &H47, &H96, &HF8, &H65, 3)
PKEY_LocationEmptyString = pkk
End Function
Public Function PKEY_MaxStackCount() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 22)
PKEY_MaxStackCount = pkk
End Function
Public Function PKEY_Message_Received() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9C1FCF74, CInt(&H2D97), CInt(&H41BA), &HB4, &HAE, &HCB, &H2E, &H36, &H61, &HA6, &HE4, 17)
PKEY_Message_Received = pkk
End Function
Public Function PKEY_Message_Type() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9C1FCF74, CInt(&H2D97), CInt(&H41BA), &HB4, &HAE, &HCB, &H2E, &H36, &H61, &HA6, &HE4, 13)
PKEY_Message_Type = pkk
End Function
Public Function PKEY_MusicStackThumbnailCacheIds() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H733CB147, CInt(&H8B1F), CInt(&H4C48), &H99, &H66, &H19, &H2F, &HDE, &H35, &H3C, &H75, 100)
PKEY_MusicStackThumbnailCacheIds = pkk
End Function
Public Function PKEY_NetworkPlacesDefaultName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 35)
PKEY_NetworkPlacesDefaultName = pkk
End Function
Public Function PKEY_NetworkProvider() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 31)
PKEY_NetworkProvider = pkk
End Function
Public Function PKEY_NetworkResource() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 1)
PKEY_NetworkResource = pkk
End Function
Public Function PKEY_NewMenuAllowedTypes() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9B174B34, CInt(&H40FF), CInt(&H11D2), &HA2, &H7E, &H0, &HC0, &H4F, &HC3, &H8, &H71, 10)
PKEY_NewMenuAllowedTypes = pkk
End Function
Public Function PKEY_NewMenuPreferredTypes() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9B174B34, CInt(&H40FF), CInt(&H11D2), &HA2, &H7E, &H0, &HC0, &H4F, &HC3, &H8, &H71, 8)
PKEY_NewMenuPreferredTypes = pkk
End Function
Public Function PKEY_OfflineSyncTime() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4E9CFC01, CInt(&H5D36), CInt(&H406A), &H83, &HCD, &H4E, &H74, &H23, &H92, &H36, &H4, 2)
PKEY_OfflineSyncTime = pkk
End Function
Public Function PKEY_Photo_FlashFired() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H2D152B40, CInt(&HCA39), CInt(&H40DB), &HB2, &HCC, &H57, &H37, &H25, &HB2, &HFE, &HC5, 100)
PKEY_Photo_FlashFired = pkk
End Function
Public Function PKEY_PropList_DetailsPaneNullSelect() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC9944A21, CInt(&HA406), CInt(&H48FE), &H82, &H25, &HAE, &HC7, &HE2, &H4C, &H21, &H1B, 510)
PKEY_PropList_DetailsPaneNullSelect = pkk
End Function
Public Function PKEY_PropList_DetailsPaneNullSelectTitle() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC9944A21, CInt(&HA406), CInt(&H48FE), &H82, &H25, &HAE, &HC7, &HE2, &H4C, &H21, &H1B, 511)
PKEY_PropList_DetailsPaneNullSelectTitle = pkk
End Function
Public Function PKEY_PropList_SetDefaultsFor() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC9944A21, CInt(&HA406), CInt(&H48FE), &H82, &H25, &HAE, &HC7, &HE2, &H4C, &H21, &H1B, 12)
PKEY_PropList_SetDefaultsFor = pkk
End Function
Public Function PKEY_PropList_StatusIcons() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HC9944A21, CInt(&HA406), CInt(&H48FE), &H82, &H25, &HAE, &HC7, &HE2, &H4C, &H21, &H1B, 16)
PKEY_PropList_StatusIcons = pkk
End Function
Public Function PKEY_RecordedTV_VideoQuality() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H6D748DE2, CInt(&H8D38), CInt(&H4CC3), &HAC, &H60, &HF0, &H9, &HB0, &H57, &HC5, &H57, 10)
PKEY_RecordedTV_VideoQuality = pkk
End Function
Public Function PKEY_ResultSourceId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 17)
PKEY_ResultSourceId = pkk
End Function
Public Function PKEY_ResultType() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 20)
PKEY_ResultType = pkk
End Function
Public Function PKEY_SAM_AccountName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H9C1FCF74, CInt(&H2D97), CInt(&H41BA), &HB4, &HAE, &HCB, &H2E, &H36, &H61, &HA6, &HE4, 10)
PKEY_SAM_AccountName = pkk
End Function
Public Function PKEY_SDID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, -2147483646)
PKEY_SDID = pkk
End Function
Public Function PKEY_Search_AccessCount() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB63E350, CInt(&H9CCC), CInt(&H11D0), &HBC, &HDB, &H0, &H80, &H5F, &HCC, &HCE, &H4, 9)
PKEY_Search_AccessCount = pkk
End Function
Public Function PKEY_Search_ClassID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, 3)
PKEY_Search_ClassID = pkk
End Function
Public Function PKEY_Search_IsFullText() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB6F5C14C, CInt(&H7403), CInt(&H4D1F), &HB3, &HC, &H91, &H5C, &H95, &HFE, &H38, &H46, 2)
PKEY_Search_IsFullText = pkk
End Function
Public Function PKEY_Search_LastChangeUSN() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, 9)
PKEY_Search_LastChangeUSN = pkk
End Function
Public Function PKEY_Search_LastIndexedTotalTime() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB63E350, CInt(&H9CCC), CInt(&H11D0), &HBC, &HDB, &H0, &H80, &H5F, &HCC, &HCE, &H4, 11)
PKEY_Search_LastIndexedTotalTime = pkk
End Function
Public Function PKEY_Search_ProviderClass() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB63E343, CInt(&H9CCC), CInt(&H11D0), &HBC, &HDB, &H0, &H80, &H5F, &HCC, &HCE, &H4, 25)
PKEY_Search_ProviderClass = pkk
End Function
Public Function PKEY_Search_ReverseFileName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H49691C90, CInt(&H7E17), CInt(&H101A), &HA9, &H1C, &H8, &H0, &H2B, &H2E, &HCD, &HA9, 8)
PKEY_Search_ReverseFileName = pkk
End Function
Public Function PKEY_Search_RowID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H49691C90, CInt(&H7E17), CInt(&H101A), &HA9, &H1C, &H8, &H0, &H2B, &H2E, &HCD, &HA9, 15)
PKEY_Search_RowID = pkk
End Function
Public Function PKEY_Search_Scope() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, 22)
PKEY_Search_Scope = pkk
End Function
Public Function PKEY_Search_ShortName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB725F130, CInt(&H47EF), CInt(&H101A), &HA5, &HF1, &H2, &H60, &H8C, &H9E, &HEB, &HAC, 20)
PKEY_Search_ShortName = pkk
End Function
Public Function PKEY_SearchScope() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HCF5751FD, CInt(&HF4B3), CInt(&H443D), &HB3, &H1C, &H9A, &H34, &H74, &H7, &H59, &HEC, 100)
PKEY_SearchScope = pkk
End Function
Public Function PKEY_Shell_IsDavResource() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBE3FD71, CInt(&H3F87), CInt(&H40E0), &HAE, &HAD, &H2, &H94, &HCF, &H67, &H46, &H35, 2)
PKEY_Shell_IsDavResource = pkk
End Function
Public Function PKEY_Shell_NavPaneRootData() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H23CDFD25, CInt(&HF531), CInt(&H4C84), &HA1, &H29, &H48, &H8D, &H15, &H6, &H82, &HF, 1)
PKEY_Shell_NavPaneRootData = pkk
End Function
Public Function PKEY_Shell_NavPaneRootFilter() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H23CDFD25, CInt(&HF531), CInt(&H4C84), &HA1, &H29, &H48, &H8D, &H15, &H6, &H82, &HF, 2)
PKEY_Shell_NavPaneRootFilter = pkk
End Function
Public Function PKEY_Software_AppId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H841E4F90, CInt(&HFF59), CInt(&H4D16), &H89, &H47, &HE8, &H1B, &HBF, &HFA, &HB3, &H6D, 5)
PKEY_Software_AppId = pkk
End Function
Public Function PKEY_Software_TasksFileUrl() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H841E4F90, CInt(&HFF59), CInt(&H4D16), &H89, &H47, &HE8, &H1B, &HBF, &HFA, &HB3, &H6D, 17)
PKEY_Software_TasksFileUrl = pkk
End Function
Public Function PKEY_StackThumbnailCacheIds() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4596208C, CInt(&H32FA), CInt(&H41D2), &H96, &H95, &HAF, &HC, &HB9, &HE8, &HDC, &HFE, 100)
PKEY_StackThumbnailCacheIds = pkk
End Function
Public Function PKEY_StartMenu_Group() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 100)
PKEY_StartMenu_Group = pkk
End Function
Public Function PKEY_StartMenu_GroupItem() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 103)
PKEY_StartMenu_GroupItem = pkk
End Function
Public Function PKEY_StartMenu_IncludeInScope() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 104)
PKEY_StartMenu_IncludeInScope = pkk
End Function
Public Function PKEY_StartMenu_Query() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 102)
PKEY_StartMenu_Query = pkk
End Function
Public Function PKEY_StartMenu_ResultSourceId() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 105)
PKEY_StartMenu_ResultSourceId = pkk
End Function
Public Function PKEY_StartMenu_RunCommand() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4BD13B3D, CInt(&HE68B), CInt(&H44EC), &H89, &HEE, &H76, &H11, &H78, &H9D, &H40, &H70, 101)
PKEY_StartMenu_RunCommand = pkk
End Function
Public Function PKEY_StructuredQuery_After() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 103)
PKEY_StructuredQuery_After = pkk
End Function
Public Function PKEY_StructuredQuery_Before() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 102)
PKEY_StructuredQuery_Before = pkk
End Function
Public Function PKEY_StructuredQuery_CustomProperty_Boolean() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 105)
PKEY_StructuredQuery_CustomProperty_Boolean = pkk
End Function
Public Function PKEY_StructuredQuery_CustomProperty_DateTime() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 109)
PKEY_StructuredQuery_CustomProperty_DateTime = pkk
End Function
Public Function PKEY_StructuredQuery_CustomProperty_FloatingPoint() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 107)
PKEY_StructuredQuery_CustomProperty_FloatingPoint = pkk
End Function
Public Function PKEY_StructuredQuery_CustomProperty_Integer() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 106)
PKEY_StructuredQuery_CustomProperty_Integer = pkk
End Function
Public Function PKEY_StructuredQuery_CustomProperty_String() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 108)
PKEY_StructuredQuery_CustomProperty_String = pkk
End Function
Public Function PKEY_StructuredQuery_Null() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7036DCFC, CInt(&H69AB), CInt(&H4316), &HB5, &HAC, &H50, &HDE, &H70, &H24, &H47, &HB0, 112)
PKEY_StructuredQuery_Null = pkk
End Function
Public Function PKEY_StructuredQuery_Virtual_IsEncrypted() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE9EDD392, CInt(&HB4C), CInt(&H4CF2), &H82, &HC0, &HB0, &HD1, &H39, &H66, &H62, &H45, 116)
PKEY_StructuredQuery_Virtual_IsEncrypted = pkk
End Function
Public Function PKEY_StructuredQuery_Virtual_IsRead() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE9EDD392, CInt(&HB4C), CInt(&H4CF2), &H82, &HC0, &HB0, &HD1, &H39, &H66, &H62, &H45, 114)
PKEY_StructuredQuery_Virtual_IsRead = pkk
End Function
Public Function PKEY_Sync_ConflictItemFullLocation() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB180AD60, CInt(&HED3F), CInt(&H4D16), &HBD, &H43, &HF5, &HB4, &HFC, &HF3, &H25, &HA9, 3)
PKEY_Sync_ConflictItemFullLocation = pkk
End Function
Public Function PKEY_Sync_ConflictItemShortLocation() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB180AD60, CInt(&HED3F), CInt(&H4D16), &HBD, &H43, &HF5, &HB4, &HFC, &HF3, &H25, &HA9, 2)
PKEY_Sync_ConflictItemShortLocation = pkk
End Function
Public Function PKEY_Sync_ConflictUnresolvable() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HCE50C159, CInt(&H2FB8), CInt(&H41FD), &HBE, &H68, &HD3, &HE0, &H42, &HE2, &H74, &HBC, 10)
PKEY_Sync_ConflictUnresolvable = pkk
End Function
Public Function PKEY_Sync_SyncResults() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7BD5533E, CInt(&HAF15), CInt(&H44DB), &HB8, &HC8, &HBD, &H66, &H24, &HE1, &HD0, &H32, 22)
PKEY_Sync_SyncResults = pkk
End Function
Public Function PKEY_Taskbar_PinnedWebsite() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H57086C23, CInt(&H86C6), CInt(&H478F), &HAF, &HB2, &H23, &H61, &H88, &HC8, &HF4, &H7F, 4)
PKEY_Taskbar_PinnedWebsite = pkk
End Function
Public Function PKEY_Taskbar_PinnedWebsiteIconUri() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H57086C23, CInt(&H86C6), CInt(&H478F), &HAF, &HB2, &H23, &H61, &H88, &HC8, &HF4, &H7F, 5)
PKEY_Taskbar_PinnedWebsiteIconUri = pkk
End Function
Public Function PKEY_Taskbar_PinnedWebsiteURL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H57086C23, CInt(&H86C6), CInt(&H478F), &HAF, &HB2, &H23, &H61, &H88, &HC8, &HF4, &H7F, 6)
PKEY_Taskbar_PinnedWebsiteURL = pkk
End Function
Public Function PKEY_Taskbar_TabActive() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H57086C23, CInt(&H86C6), CInt(&H478F), &HAF, &HB2, &H23, &H61, &H88, &HC8, &HF4, &H7F, 2)
PKEY_Taskbar_TabActive = pkk
End Function
Public Function PKEY_Taskbar_TabList() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H57086C23, CInt(&H86C6), CInt(&H478F), &HAF, &HB2, &H23, &H61, &H88, &HC8, &HF4, &H7F, 3)
PKEY_Taskbar_TabList = pkk
End Function
Public Function PKEY_ThumbnailCacheIdParts() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 24)
PKEY_ThumbnailCacheIdParts = pkk
End Function
Public Function PKEY_TransferPath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HCEBF9B37, CInt(&H26AE), CInt(&H466B), &H9F, &HE9, &HC7, &H55, &HC, &H4B, &HC, &HE8, 100)
PKEY_TransferPath = pkk
End Function
Public Function PKEY_UrlHostName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5CBF2787, CInt(&H48CF), CInt(&H4208), &HB9, &HE, &HEE, &H5E, &H5D, &H42, &H2, &H94, 4)
PKEY_UrlHostName = pkk
End Function
Public Function PKEY_UserDisplayName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H54B3A473, CInt(&H59AA), CInt(&H445B), &HAE, &HCD, &H77, &H54, &H1B, &HA8, &HB7, &HC9, 3)
PKEY_UserDisplayName = pkk
End Function
Public Function PKEY_UserName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H54B3A473, CInt(&H59AA), CInt(&H445B), &HAE, &HCD, &H77, &H54, &H1B, &HA8, &HB7, &HC9, 2)
PKEY_UserName = pkk
End Function
Public Function PKEY_UserProfilePath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H54B3A473, CInt(&H59AA), CInt(&H445B), &HAE, &HCD, &H77, &H54, &H1B, &HA8, &HB7, &HC9, 5)
PKEY_UserProfilePath = pkk
End Function
Public Function PKEY_VerbRestrictions() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H705CCB0F, CInt(&H5A0D), CInt(&H41EA), &HB2, &HCA, &H2C, &H9B, &H5C, &HC7, &HDB, &H41, 100)
PKEY_VerbRestrictions = pkk
End Function
Public Function PKEY_WebDavPath() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1804D1FB, CInt(&H9FA4), CInt(&H441D), &HA5, &H36, &H76, &H46, &H8A, &HC4, &H33, &H7, 100)
PKEY_WebDavPath = pkk
End Function
Public Function PKEY_WebPreviewUrl() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1E3EE840, CInt(&HBC2B), CInt(&H476C), &H82, &H37, &H2A, &HCD, &H1A, &H83, &H9B, &H22, 23)
PKEY_WebPreviewUrl = pkk
End Function
Public Function PKEY_WhichFolder() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H28636AA6, CInt(&H953D), CInt(&H11D2), &HB5, &HD6, &H0, &HC0, &H4F, &HD9, &H18, &HD0, 3)
PKEY_WhichFolder = pkk
End Function
Public Function PKEY_Fonts_ActiveStatus() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HD6CF9145, CInt(&HD365), CInt(&H471B), &HBC, &HB8, &HF0, &HB4, &HA9, &H6B, &H89, &H1C, 100)
PKEY_Fonts_ActiveStatus = pkk
End Function
Public Function PKEY_Fonts_Category() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4B486401, CInt(&H5468), CInt(&H4381), &H9B, &H5A, &H42, &HDF, &H4C, &HB4, &H9F, &H53, 100)
PKEY_Fonts_Category = pkk
End Function
Public Function PKEY_Fonts_CollectionName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HF3AECAC4, CInt(&H5B8D), CInt(&H436A), &HAD, &HC, &H64, &HAB, &H19, &H4F, &HDA, &HF3, 100)
PKEY_Fonts_CollectionName = pkk
End Function
Public Function PKEY_Fonts_Description() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3D658D4D, CInt(&HBC38), CInt(&H464A), &HB5, &H55, &H41, &H8D, &H55, &H4A, &H8D, &HF8, 100)
PKEY_Fonts_Description = pkk
End Function
Public Function PKEY_Fonts_DesignedFor() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H5741CF9C, CInt(&H56FE), CInt(&H485B), &H89, &H1, &H47, &H86, &H44, &H9E, &H18, &H8D, 100)
PKEY_Fonts_DesignedFor = pkk
End Function
Public Function PKEY_Fonts_FamilyName() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HDE9E220B, CInt(&H41D4), CInt(&H4690), &H8B, &H6B, &H3D, &H89, &HE2, &H31, &HEE, &HF1, 100)
PKEY_Fonts_FamilyName = pkk
End Function
Public Function PKEY_Fonts_FileNames() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4530D076, CInt(&HB598), CInt(&H4A81), &H88, &H13, &H9B, &H11, &H28, &H6E, &HF6, &HEA, 7)
PKEY_Fonts_FileNames = pkk
End Function
Public Function PKEY_Fonts_FontEmbeddability() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4530D076, CInt(&HB598), CInt(&H4A81), &H88, &H13, &H9B, &H11, &H28, &H6E, &HF6, &HEA, 2)
PKEY_Fonts_FontEmbeddability = pkk
End Function
Public Function PKEY_Fonts_Styles() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H596FD41B, CInt(&HAF9B), CInt(&H4BA8), &H9B, &H49, &H33, &HB1, &H6F, &H16, &H67, &H8C, 100)
PKEY_Fonts_Styles = pkk
End Function
Public Function PKEY_Fonts_Type() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H4530D076, CInt(&HB598), CInt(&H4A81), &H88, &H13, &H9B, &H11, &H28, &H6E, &HF6, &HEA, 5)
PKEY_Fonts_Type = pkk
End Function
Public Function PKEY_Fonts_Vendors() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H49753869, CInt(&H849C), CInt(&H4323), &HA4, &H1F, &H26, &HD7, &H3F, &H28, &HB5, &H3B, 100)
PKEY_Fonts_Vendors = pkk
End Function
Public Function PKEY_Fonts_Version() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HFEC7952B, CInt(&H4BF0), CInt(&H4C03), &HB6, &HE1, &H27, &H96, &H81, &H8B, &H7C, &HA9, 100)
PKEY_Fonts_Version = pkk
End Function
Public Function PKEY_ZipFolder_CompressedSize() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE88DCCE0, CInt(&HB7B3), CInt(&H11D1), &HA9, &HF0, &H0, &HAA, &H0, &H60, &HFA, &H31, 6)
PKEY_ZipFolder_CompressedSize = pkk
End Function
Public Function PKEY_ZipFolder_CRC32() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE88DCCE0, CInt(&HB7B3), CInt(&H11D1), &HA9, &HF0, &H0, &HAA, &H0, &H60, &HFA, &H31, 5)
PKEY_ZipFolder_CRC32 = pkk
End Function
Public Function PKEY_ZipFolder_Encrypted() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE88DCCE0, CInt(&HB7B3), CInt(&H11D1), &HA9, &HF0, &H0, &HAA, &H0, &H60, &HFA, &H31, 2)
PKEY_ZipFolder_Encrypted = pkk
End Function
Public Function PKEY_ZipFolder_Method() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE88DCCE0, CInt(&HB7B3), CInt(&H11D1), &HA9, &HF0, &H0, &HAA, &H0, &H60, &HFA, &H31, 3)
PKEY_ZipFolder_Method = pkk
End Function
Public Function PKEY_ZipFolder_Ratio() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE88DCCE0, CInt(&HB7B3), CInt(&H11D1), &HA9, &HF0, &H0, &HAA, &H0, &H60, &HFA, &H31, 4)
PKEY_ZipFolder_Ratio = pkk
End Function


Public Function UI_PKEY_Enabled() As PROPERTYKEY
'{00000001-7363-696e-8441-798acf5aebb7, 11
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H1, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 11)
 UI_PKEY_Enabled = iid
End Function
Public Function UI_PKEY_LabelDescription() As PROPERTYKEY
'{00000002-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H2, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_LabelDescription = iid
End Function
Public Function UI_PKEY_Keytip() As PROPERTYKEY
'{00000003-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H3, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_Keytip = iid
End Function
Public Function UI_PKEY_Label() As PROPERTYKEY
'{00000004-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H4, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_Label = iid
End Function
Public Function UI_PKEY_TooltipDescription() As PROPERTYKEY
'{00000005-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H5, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_TooltipDescription = iid
End Function
Public Function UI_PKEY_TooltipTitle() As PROPERTYKEY
'{00000006-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H6, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_TooltipTitle = iid
End Function
Public Function UI_PKEY_LargeImage() As PROPERTYKEY
'{00000007-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H7, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_LargeImage = iid
End Function
Public Function UI_PKEY_LargeHighContrastImage() As PROPERTYKEY
'{00000008-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H8, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_LargeHighContrastImage = iid
End Function
Public Function UI_PKEY_SmallImage() As PROPERTYKEY
'{00000009-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H9, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_SmallImage = iid
End Function
Public Function UI_PKEY_SmallHighContrastImage() As PROPERTYKEY
'{0000000a-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HA, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_SmallHighContrastImage = iid
End Function
Public Function UI_PKEY_CommandId() As PROPERTYKEY
'{00000064-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H64, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_CommandId = iid
End Function
Public Function UI_PKEY_ItemsSource() As PROPERTYKEY
'{00000065-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H65, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_ItemsSource = iid
End Function
Public Function UI_PKEY_Categories() As PROPERTYKEY
'{00000066-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H66, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_Categories = iid
End Function
Public Function UI_PKEY_CategoryId() As PROPERTYKEY
'{00000067-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H67, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_CategoryId = iid
End Function
Public Function UI_PKEY_SelectedItem() As PROPERTYKEY
'{00000068-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H68, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_SelectedItem = iid
End Function
Public Function UI_PKEY_CommandType() As PROPERTYKEY
'{00000069-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H69, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_CommandType = iid
End Function
Public Function UI_PKEY_ItemImage() As PROPERTYKEY
'{0000006a-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H6A, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_ItemImage = iid
End Function
Public Function UI_PKEY_BooleanValue() As PROPERTYKEY
'{000000c8-7363-696e-8441-798acf5aebb7, 11
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HC8, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 11)
 UI_PKEY_BooleanValue = iid
End Function
Public Function UI_PKEY_DecimalValue() As PROPERTYKEY
'{000000c9-7363-696e-8441-798acf5aebb7, 14
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HC9, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 14)
 UI_PKEY_DecimalValue = iid
End Function
Public Function UI_PKEY_StringValue() As PROPERTYKEY
'{000000ca-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCA, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_StringValue = iid
End Function
Public Function UI_PKEY_MaxValue() As PROPERTYKEY
'{000000cb-7363-696e-8441-798acf5aebb7, 14
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCB, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 14)
 UI_PKEY_MaxValue = iid
End Function
Public Function UI_PKEY_MinValue() As PROPERTYKEY
'{000000cc-7363-696e-8441-798acf5aebb7, 14
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCC, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 14)
 UI_PKEY_MinValue = iid
End Function
Public Function UI_PKEY_Increment() As PROPERTYKEY
'{000000cd-7363-696e-8441-798acf5aebb7, 14
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCD, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 14)
 UI_PKEY_Increment = iid
End Function
Public Function UI_PKEY_DecimalPlaces() As PROPERTYKEY
'{000000ce-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCE, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_DecimalPlaces = iid
End Function
Public Function UI_PKEY_FormatString() As PROPERTYKEY
'{000000cf-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HCF, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_FormatString = iid
End Function
Public Function UI_PKEY_RepresentativeString() As PROPERTYKEY
'{000000d0-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &HD0, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_RepresentativeString = iid
End Function
Public Function UI_PKEY_FontProperties() As PROPERTYKEY
'{0000012c-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H12C, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_FontProperties = iid
End Function
Public Function UI_PKEY_FontProperties_Family() As PROPERTYKEY
'{0000012d-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H12D, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_FontProperties_Family = iid
End Function
Public Function UI_PKEY_FontProperties_Size() As PROPERTYKEY
'{0000012e-7363-696e-8441-798acf5aebb7, 14
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H12E, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 14)
 UI_PKEY_FontProperties_Size = iid
End Function
Public Function UI_PKEY_FontProperties_Bold() As PROPERTYKEY
'{0000012f-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H12F, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_Bold = iid
End Function
Public Function UI_PKEY_FontProperties_Italic() As PROPERTYKEY
'{00000130-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H130, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_Italic = iid
End Function
Public Function UI_PKEY_FontProperties_Underline() As PROPERTYKEY
'{00000131-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H131, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_Underline = iid
End Function
Public Function UI_PKEY_FontProperties_Strikethrough() As PROPERTYKEY
'{00000132-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H132, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_Strikethrough = iid
End Function
Public Function UI_PKEY_FontProperties_VerticalPositioning() As PROPERTYKEY
'{00000133-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H133, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_VerticalPositioning = iid
End Function
Public Function UI_PKEY_FontProperties_ForegroundColor() As PROPERTYKEY
'{00000134-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H134, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_ForegroundColor = iid
End Function
Public Function UI_PKEY_FontProperties_BackgroundColor() As PROPERTYKEY
'{00000135-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H135, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_BackgroundColor = iid
End Function
Public Function UI_PKEY_FontProperties_ForegroundColorType() As PROPERTYKEY
'{00000136-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H136, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_ForegroundColorType = iid
End Function
Public Function UI_PKEY_FontProperties_BackgroundColorType() As PROPERTYKEY
'{00000137-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H137, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_BackgroundColorType = iid
End Function
Public Function UI_PKEY_FontProperties_ChangedProperties() As PROPERTYKEY
'{00000138-7363-696e-8441-798acf5aebb7, 13
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H138, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 13)
 UI_PKEY_FontProperties_ChangedProperties = iid
End Function
Public Function UI_PKEY_FontProperties_DeltaSize() As PROPERTYKEY
'{00000139-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H139, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_FontProperties_DeltaSize = iid
End Function
Public Function UI_PKEY_RecentItems() As PROPERTYKEY
'{0000015e-7363-696e-8441-798acf5aebb7, &H200D
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H15E, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, &H200D)
 UI_PKEY_RecentItems = iid
End Function
Public Function UI_PKEY_Pinned() As PROPERTYKEY
'{0000015f-7363-696e-8441-798acf5aebb7, 11
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H15F, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 11)
 UI_PKEY_Pinned = iid
End Function
Public Function UI_PKEY_Color() As PROPERTYKEY
'{00000190-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H190, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_Color = iid
End Function
Public Function UI_PKEY_ColorType() As PROPERTYKEY
'{00000191-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H191, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_ColorType = iid
End Function
Public Function UI_PKEY_ColorMode() As PROPERTYKEY
'{00000192-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H192, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_ColorMode = iid
End Function
Public Function UI_PKEY_ThemeColorsCategoryLabel() As PROPERTYKEY
'{00000193-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H193, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_ThemeColorsCategoryLabel = iid
End Function
Public Function UI_PKEY_StandardColorsCategoryLabel() As PROPERTYKEY
'{00000194-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H194, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_StandardColorsCategoryLabel = iid
End Function
Public Function UI_PKEY_RecentColorsCategoryLabel() As PROPERTYKEY
'{00000195-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H195, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_RecentColorsCategoryLabel = iid
End Function
Public Function UI_PKEY_AutomaticColorLabel() As PROPERTYKEY
'{00000196-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H196, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_AutomaticColorLabel = iid
End Function
Public Function UI_PKEY_NoColorLabel() As PROPERTYKEY
'{00000197-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H197, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_NoColorLabel = iid
End Function
Public Function UI_PKEY_MoreColorsLabel() As PROPERTYKEY
'{00000198-7363-696e-8441-798acf5aebb7, 31
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H198, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 31)
 UI_PKEY_MoreColorsLabel = iid
End Function
Public Function UI_PKEY_ThemeColors() As PROPERTYKEY
'{00000199-7363-696e-8441-798acf5aebb7, &H1013
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H199, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, &H1013)
 UI_PKEY_ThemeColors = iid
End Function
Public Function UI_PKEY_StandardColors() As PROPERTYKEY
'{0000019a-7363-696e-8441-798acf5aebb7, &H1013
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H19A, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, &H1013)
 UI_PKEY_StandardColors = iid
End Function
Public Function UI_PKEY_ThemeColorsTooltips() As PROPERTYKEY
'{0000019b-7363-696e-8441-798acf5aebb7, &H101f
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H19B, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, &H101F)
 UI_PKEY_ThemeColorsTooltips = iid
End Function
Public Function UI_PKEY_StandardColorsTooltips() As PROPERTYKEY
'{0000019c-7363-696e-8441-798acf5aebb7, &H101f
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H19C, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, &H101F)
 UI_PKEY_StandardColorsTooltips = iid
End Function
Public Function UI_PKEY_Viewable() As PROPERTYKEY
'{0000038e-7363-696e-8441-798acf5aebb7, 11
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H38E, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 11)
 UI_PKEY_Viewable = iid
End Function
Public Function UI_PKEY_Minimized() As PROPERTYKEY
'{0000038f-7363-696e-8441-798acf5aebb7, 11
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H38F, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 11)
 UI_PKEY_Minimized = iid
End Function
Public Function UI_PKEY_QuickAccessToolbarDock() As PROPERTYKEY
'{00000390-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H390, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_QuickAccessToolbarDock = iid
End Function
Public Function UI_PKEY_ContextAvailable() As PROPERTYKEY
'{0000044c-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H44C, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_ContextAvailable = iid
End Function
Public Function UI_PKEY_GlobalBackgroundColor() As PROPERTYKEY
'{000007d0-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H7D0, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_GlobalBackgroundColor = iid
End Function
Public Function UI_PKEY_GlobalHighlightColor() As PROPERTYKEY
'{000007d1-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H7D1, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_GlobalHighlightColor = iid
End Function
Public Function UI_PKEY_GlobalTextColor() As PROPERTYKEY
'{000007d2-7363-696e-8441-798acf5aebb7, 19
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H7D2, CInt(&H7363), CInt(&H696E), &H84, &H41, &H79, &H8A, &HCF, &H5A, &HEB, &HB7, 19)
 UI_PKEY_GlobalTextColor = iid
End Function


'The following do not have equivalent PKEY entries:
Public Function SCID_DateDeleted() As PROPERTYKEY
'{9B174B33-40FF-11D2-A27E-00C04FC30871, 3
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H9B174B33, CInt(&H40FF), CInt(&H11D2), &HA2, &H7E, &H0, &HC0, &H4F, &HC3, &H8, &H71, 3)
 SCID_DateDeleted = iid
End Function
Public Function SCID_OriginalLocation() As PROPERTYKEY
'{9B174B33-40FF-11D2-A27E-00C04FC30871, 2
Static iid As PROPERTYKEY
 If (iid.fmtid.Data1 = 0) Then Call DEFINE_PROPERTYKEY(iid, &H9B174B33, CInt(&H40FF), CInt(&H11D2), &HA2, &H7E, &H0, &HC0, &H4F, &HC3, &H8, &H71, 2)
 SCID_OriginalLocation = iid
End Function


Public Function SENSOR_EVENT_PARAMETER_EVENT_ID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H64346E30, &H8728, &H4B34, &HBD, &HF6, &H4F, &H52, &H44, &H2C, &H5C, &H28, 2)
SENSOR_EVENT_PARAMETER_EVENT_ID = pkk
End Function
Public Function SENSOR_EVENT_PARAMETER_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H64346E30, &H8728, &H4B34, &HBD, &HF6, &H4F, &H52, &H44, &H2C, &H5C, &H28, 3)
 '[VT_UI4]
SENSOR_EVENT_PARAMETER_STATE = pkk
End Function
Public Function SENSOR_PROPERTY_TYPE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 2)
 'VT_CLSID]
SENSOR_PROPERTY_TYPE = pkk
End Function
Public Function SENSOR_PROPERTY_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 3)
 'VT_UI4]
SENSOR_PROPERTY_STATE = pkk
End Function
Public Function SENSOR_PROPERTY_PERSISTENT_UNIQUE_ID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 5)
 'VT_CLSID]
SENSOR_PROPERTY_PERSISTENT_UNIQUE_ID = pkk
End Function
Public Function SENSOR_PROPERTY_MANUFACTURER() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 6)
 'VT_LPWSTR]
SENSOR_PROPERTY_MANUFACTURER = pkk
End Function
Public Function SENSOR_PROPERTY_MODEL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 7)
 'VT_LPWSTR]
SENSOR_PROPERTY_MODEL = pkk
End Function
Public Function SENSOR_PROPERTY_SERIAL_NUMBER() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 8)
 'VT_LPWSTR]
SENSOR_PROPERTY_SERIAL_NUMBER = pkk
End Function
Public Function SENSOR_PROPERTY_FRIENDLY_NAME() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 9)
 'VT_LPWSTR]
SENSOR_PROPERTY_FRIENDLY_NAME = pkk
End Function
Public Function SENSOR_PROPERTY_DESCRIPTION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 10)
 'VT_LPWSTR]
SENSOR_PROPERTY_DESCRIPTION = pkk
End Function
Public Function SENSOR_PROPERTY_CONNECTION_TYPE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 11)
 'VT_UI4]
SENSOR_PROPERTY_CONNECTION_TYPE = pkk
End Function
Public Function SENSOR_PROPERTY_MIN_REPORT_INTERVAL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 12)
 'VT_UI4]
SENSOR_PROPERTY_MIN_REPORT_INTERVAL = pkk
End Function
Public Function SENSOR_PROPERTY_CURRENT_REPORT_INTERVAL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 13)
 'VT_UI4]
SENSOR_PROPERTY_CURRENT_REPORT_INTERVAL = pkk
End Function
Public Function SENSOR_PROPERTY_CHANGE_SENSITIVITY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 14)
 'VT_UNKNOWN], IPortableDeviceValues
SENSOR_PROPERTY_CHANGE_SENSITIVITY = pkk
End Function
Public Function SENSOR_PROPERTY_DEVICE_PATH() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 15)
 'VT_LPWSTR]
SENSOR_PROPERTY_DEVICE_PATH = pkk
End Function
Public Function SENSOR_PROPERTY_LIGHT_RESPONSE_CURVE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 16)
 'VT_VECTOR|VT_UI1]
SENSOR_PROPERTY_LIGHT_RESPONSE_CURVE = pkk
End Function
Public Function SENSOR_PROPERTY_ACCURACY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 17)
 'VT_UNKNOWN], IPortableDeviceValues
SENSOR_PROPERTY_ACCURACY = pkk
End Function
Public Function SENSOR_PROPERTY_RESOLUTION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 18)
 'VT_UNKNOWN], IPortableDeviceValues
SENSOR_PROPERTY_RESOLUTION = pkk
End Function
Public Function SENSOR_PROPERTY_LOCATION_DESIRED_ACCURACY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 19)
 'VT_UI4]
SENSOR_PROPERTY_LOCATION_DESIRED_ACCURACY = pkk
End Function
Public Function SENSOR_PROPERTY_RANGE_MINIMUM() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 20)
 'VT_UNKNOWN], IPortableDeviceValues
SENSOR_PROPERTY_RANGE_MINIMUM = pkk
End Function
Public Function SENSOR_PROPERTY_RANGE_MAXIMUM() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 21)
 'VT_UNKNOWN], IPortableDeviceValues
SENSOR_PROPERTY_RANGE_MAXIMUM = pkk
End Function
Public Function SENSOR_PROPERTY_HID_USAGE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 22)
 'VT_UI4]
SENSOR_PROPERTY_HID_USAGE = pkk
End Function
Public Function SENSOR_PROPERTY_RADIO_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 23)
 'VT_UI4]
SENSOR_PROPERTY_RADIO_STATE = pkk
End Function
Public Function SENSOR_PROPERTY_RADIO_STATE_PREVIOUS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H7F8383EC, &HD3EC, &H495C, &HA8, &HCF, &HB8, &HBB, &HE8, &H5C, &H29, &H20, 24)
 'VT_UI4]
SENSOR_PROPERTY_RADIO_STATE_PREVIOUS = pkk
End Function
Public Function SENSOR_DATA_TYPE_TIMESTAMP() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HDB5E0CF2, &HCF1F, &H4C18, &HB4, &H6C, &HD8, &H60, &H11, &HD6, &H21, &H50, 2)
 'VT_FILETIME]
SENSOR_DATA_TYPE_TIMESTAMP = pkk
End Function
Public Function SENSOR_DATA_TYPE_LATITUDE_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 2)
 'VT_R8]
SENSOR_DATA_TYPE_LATITUDE_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_LONGITUDE_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 3)
 'VT_R8]
SENSOR_DATA_TYPE_LONGITUDE_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 4)
 'VT_R8]
SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 5)
 'VT_R8]
SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_SPEED_KNOTS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 6)
 'VT_R8]
SENSOR_DATA_TYPE_SPEED_KNOTS = pkk
End Function
Public Function SENSOR_DATA_TYPE_TRUE_HEADING_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 7)
 'VT_R8]
SENSOR_DATA_TYPE_TRUE_HEADING_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 8)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_VARIATION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 9)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_VARIATION = pkk
End Function
Public Function SENSOR_DATA_TYPE_FIX_QUALITY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 10)
 'VT_I4]
SENSOR_DATA_TYPE_FIX_QUALITY = pkk
End Function
Public Function SENSOR_DATA_TYPE_FIX_TYPE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 11)
 'VT_I4]
SENSOR_DATA_TYPE_FIX_TYPE = pkk
End Function
Public Function SENSOR_DATA_TYPE_POSITION_DILUTION_OF_PRECISION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 12)
 'VT_R8]
SENSOR_DATA_TYPE_POSITION_DILUTION_OF_PRECISION = pkk
End Function
Public Function SENSOR_DATA_TYPE_HORIZONAL_DILUTION_OF_PRECISION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 13)
 'VT_R8]
SENSOR_DATA_TYPE_HORIZONAL_DILUTION_OF_PRECISION = pkk
End Function
Public Function SENSOR_DATA_TYPE_VERTICAL_DILUTION_OF_PRECISION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 14)
 'VT_R8]
SENSOR_DATA_TYPE_VERTICAL_DILUTION_OF_PRECISION = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_USED_COUNT() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 15)
 'VT_I4]
SENSOR_DATA_TYPE_SATELLITES_USED_COUNT = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_USED_PRNS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 16)
 'VT_VECTOR | VT_UI1]
SENSOR_DATA_TYPE_SATELLITES_USED_PRNS = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 17)
 'VT_I4]
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_PRNS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 18)
 'VT_VECTOR | VT_UI1]
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_PRNS = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ELEVATION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 19)
 'VT_VECTOR | VT_UI1]
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ELEVATION = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_AZIMUTH() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 20)
 'VT_VECTOR | VT_UI1
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_AZIMUTH = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_STN_RATIO() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 21)
 'VT_VECTOR | VT_UI1]
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_STN_RATIO = pkk
End Function
Public Function SENSOR_DATA_TYPE_ERROR_RADIUS_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 22)
 'VT_R8]
SENSOR_DATA_TYPE_ERROR_RADIUS_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_ADDRESS1() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 23)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_ADDRESS1 = pkk
End Function
Public Function SENSOR_DATA_TYPE_ADDRESS2() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 24)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_ADDRESS2 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CITY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 25)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_CITY = pkk
End Function
Public Function SENSOR_DATA_TYPE_STATE_PROVINCE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 26)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_STATE_PROVINCE = pkk
End Function
Public Function SENSOR_DATA_TYPE_POSTALCODE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 27)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_POSTALCODE = pkk
End Function
Public Function SENSOR_DATA_TYPE_COUNTRY_REGION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 28)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_COUNTRY_REGION = pkk
End Function
Public Function SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_ERROR_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 29)
 'VT_R8]
SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_ERROR_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_ERROR_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 30)
 'VT_R8]
SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_ERROR_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_GPS_SELECTION_MODE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 31)
 'VT_I4]
SENSOR_DATA_TYPE_GPS_SELECTION_MODE = pkk
End Function
Public Function SENSOR_DATA_TYPE_GPS_OPERATION_MODE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 32)
 'VT_I4]
SENSOR_DATA_TYPE_GPS_OPERATION_MODE = pkk
End Function
Public Function SENSOR_DATA_TYPE_GPS_STATUS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 33)
 'VT_I4]
SENSOR_DATA_TYPE_GPS_STATUS = pkk
End Function
Public Function SENSOR_DATA_TYPE_GEOIDAL_SEPARATION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 34)
 'VT_R8]
SENSOR_DATA_TYPE_GEOIDAL_SEPARATION = pkk
End Function
Public Function SENSOR_DATA_TYPE_DGPS_DATA_AGE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 35)
 'VT_R8]
SENSOR_DATA_TYPE_DGPS_DATA_AGE = pkk
End Function
Public Function SENSOR_DATA_TYPE_ALTITUDE_ANTENNA_SEALEVEL_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 36)
 'VT_R8]
SENSOR_DATA_TYPE_ALTITUDE_ANTENNA_SEALEVEL_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_DIFFERENTIAL_REFERENCE_STATION_ID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 37)
 'VT_I4]
SENSOR_DATA_TYPE_DIFFERENTIAL_REFERENCE_STATION_ID = pkk
End Function
Public Function SENSOR_DATA_TYPE_NMEA_SENTENCE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 38)
 'VT_LPWSTR]
SENSOR_DATA_TYPE_NMEA_SENTENCE = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ID() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 39)
 'VT_VECTOR|VT_UI1]
SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ID = pkk
End Function
Public Function SENSOR_DATA_TYPE_LOCATION_SOURCE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 40)
 'VT_UI4]
SENSOR_DATA_TYPE_LOCATION_SOURCE = pkk
End Function
Public Function SENSOR_DATA_TYPE_SATELLITES_USED_PRNS_AND_CONSTELLATIONS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H55C74D8, &HCA6F, &H47D6, &H95, &HC6, &H1E, &HD3, &H63, &H7A, &HF, &HF4, 41)
 'VT_VECTOR | VT_UI2]
SENSOR_DATA_TYPE_SATELLITES_USED_PRNS_AND_CONSTELLATIONS = pkk
End Function
Public Function SENSOR_DATA_TYPE_TEMPERATURE_CELSIUS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8B0AA2F1, &H2D57, &H42EE, &H8C, &HC0, &H4D, &H27, &H62, &H2B, &H46, &HC4, 2)
 'VT_R4]
SENSOR_DATA_TYPE_TEMPERATURE_CELSIUS = pkk
End Function
Public Function SENSOR_DATA_TYPE_RELATIVE_HUMIDITY_PERCENT() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8B0AA2F1, &H2D57, &H42EE, &H8C, &HC0, &H4D, &H27, &H62, &H2B, &H46, &HC4, 3)
 'VT_R4]
SENSOR_DATA_TYPE_RELATIVE_HUMIDITY_PERCENT = pkk
End Function
Public Function SENSOR_DATA_TYPE_ATMOSPHERIC_PRESSURE_BAR() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8B0AA2F1, &H2D57, &H42EE, &H8C, &HC0, &H4D, &H27, &H62, &H2B, &H46, &HC4, 4)
 'VT_R4]
SENSOR_DATA_TYPE_ATMOSPHERIC_PRESSURE_BAR = pkk
End Function
Public Function SENSOR_DATA_TYPE_WIND_DIRECTION_DEGREES_ANTICLOCKWISE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8B0AA2F1, &H2D57, &H42EE, &H8C, &HC0, &H4D, &H27, &H62, &H2B, &H46, &HC4, 5)
 'VT_R4]
SENSOR_DATA_TYPE_WIND_DIRECTION_DEGREES_ANTICLOCKWISE = pkk
End Function
Public Function SENSOR_DATA_TYPE_WIND_SPEED_METERS_PER_SECOND() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H8B0AA2F1, &H2D57, &H42EE, &H8C, &HC0, &H4D, &H27, &H62, &H2B, &H46, &HC4, 6)
 'VT_R4]
SENSOR_DATA_TYPE_WIND_SPEED_METERS_PER_SECOND = pkk
End Function
Public Function SENSOR_DATA_TYPE_ACCELERATION_X_G() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 2)
 'VT_R8]
SENSOR_DATA_TYPE_ACCELERATION_X_G = pkk
End Function
Public Function SENSOR_DATA_TYPE_ACCELERATION_Y_G() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 3)
 'VT_R8]
SENSOR_DATA_TYPE_ACCELERATION_Y_G = pkk
End Function
Public Function SENSOR_DATA_TYPE_ACCELERATION_Z_G() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 4)
 'VT_R8]
SENSOR_DATA_TYPE_ACCELERATION_Z_G = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_X_DEGREES_PER_SECOND_SQUARED() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 5)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_X_DEGREES_PER_SECOND_SQUARED = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Y_DEGREES_PER_SECOND_SQUARED() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 6)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Y_DEGREES_PER_SECOND_SQUARED = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Z_DEGREES_PER_SECOND_SQUARED() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 7)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Z_DEGREES_PER_SECOND_SQUARED = pkk
End Function
Public Function SENSOR_DATA_TYPE_SPEED_METERS_PER_SECOND() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 8)
 'VT_R8]
SENSOR_DATA_TYPE_SPEED_METERS_PER_SECOND = pkk
End Function
Public Function SENSOR_DATA_TYPE_MOTION_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 9)
 'VT_BOOL]
SENSOR_DATA_TYPE_MOTION_STATE = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_VELOCITY_X_DEGREES_PER_SECOND() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 10)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_VELOCITY_X_DEGREES_PER_SECOND = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 11)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND = pkk
End Function
Public Function SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H3F8A69A2, &H7C5, &H4E48, &HA9, &H65, &HCD, &H79, &H7A, &HAB, &H56, &HD5, 12)
 'VT_R8]
SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND = pkk
End Function
Public Function SENSOR_DATA_TYPE_TILT_X_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 2)
 'VT_R4]
SENSOR_DATA_TYPE_TILT_X_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_TILT_Y_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 3)
 'VT_R4]
SENSOR_DATA_TYPE_TILT_Y_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_TILT_Z_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 4)
 'VT_R4]
SENSOR_DATA_TYPE_TILT_Z_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_X_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 5)
 'VT_R4]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_X_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_Y_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 6)
 'VT_R4]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_Y_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_Z_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 7)
 'VT_R4]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_Z_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_DISTANCE_X_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 8)
 'VT_R4]
SENSOR_DATA_TYPE_DISTANCE_X_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_DISTANCE_Y_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 9)
 'VT_R4]
SENSOR_DATA_TYPE_DISTANCE_Y_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_DISTANCE_Z_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 10)
 'VT_R4]
SENSOR_DATA_TYPE_DISTANCE_Z_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 11)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 12)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 13)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_HEADING_TRUE_NORTH_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 14)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_HEADING_TRUE_NORTH_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_QUADRANT_ANGLE_DEGREES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 15)
 'VT_R8]
SENSOR_DATA_TYPE_QUADRANT_ANGLE_DEGREES = pkk
End Function
Public Function SENSOR_DATA_TYPE_ROTATION_MATRIX() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 16)
 'VT_VECTOR|VT_UI1]
SENSOR_DATA_TYPE_ROTATION_MATRIX = pkk
End Function
Public Function SENSOR_DATA_TYPE_QUATERNION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 17)
 'VT_VECTOR|VT_UI1]
SENSOR_DATA_TYPE_QUATERNION = pkk
End Function
Public Function SENSOR_DATA_TYPE_SIMPLE_DEVICE_ORIENTATION() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 18)
 'VT_UI4]
SENSOR_DATA_TYPE_SIMPLE_DEVICE_ORIENTATION = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 19)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 20)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 21)
 'VT_R8]
SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS = pkk
End Function
Public Function SENSOR_DATA_TYPE_MAGNETOMETER_ACCURACY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H1637D8A2, &H4248, &H4275, &H86, &H5D, &H55, &H8D, &HE8, &H4A, &HED, &HFD, 22)
 'VT_I4]
SENSOR_DATA_TYPE_MAGNETOMETER_ACCURACY = pkk
End Function
Public Function SENSOR_DATA_TYPE_BOOLEAN_SWITCH_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 2)
 'VT_BOOL]
SENSOR_DATA_TYPE_BOOLEAN_SWITCH_STATE = pkk
End Function
Public Function SENSOR_DATA_TYPE_MULTIVALUE_SWITCH_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 3)
 'VT_R8]
SENSOR_DATA_TYPE_MULTIVALUE_SWITCH_STATE = pkk
End Function
Public Function SENSOR_DATA_TYPE_FORCE_NEWTONS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 4)
 'VT_R8]
SENSOR_DATA_TYPE_FORCE_NEWTONS = pkk
End Function
Public Function SENSOR_DATA_TYPE_ABSOLUTE_PRESSURE_PASCAL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 5)
 'VT_R8]
SENSOR_DATA_TYPE_ABSOLUTE_PRESSURE_PASCAL = pkk
End Function
Public Function SENSOR_DATA_TYPE_GAUGE_PRESSURE_PASCAL() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 6)
 'VT_R8]
SENSOR_DATA_TYPE_GAUGE_PRESSURE_PASCAL = pkk
End Function
Public Function SENSOR_DATA_TYPE_STRAIN() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 7)
 'VT_R8]
SENSOR_DATA_TYPE_STRAIN = pkk
End Function
Public Function SENSOR_DATA_TYPE_WEIGHT_KILOGRAMS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 8)
 'VT_R8]
SENSOR_DATA_TYPE_WEIGHT_KILOGRAMS = pkk
End Function
Public Function SENSOR_DATA_TYPE_BOOLEAN_SWITCH_ARRAY_STATES() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H38564A7C, &HF2F2, &H49BB, &H9B, &H2B, &HBA, &H60, &HF6, &H6A, &H58, &HDF, 10)
 'VT_UI4]
SENSOR_DATA_TYPE_BOOLEAN_SWITCH_ARRAY_STATES = pkk
End Function
Public Function SENSOR_DATA_TYPE_HUMAN_PRESENCE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H2299288A, &H6D9E, &H4B0B, &HB7, &HEC, &H35, &H28, &HF8, &H9E, &H40, &HAF, 2)
 'VT_BOOL]
SENSOR_DATA_TYPE_HUMAN_PRESENCE = pkk
End Function
Public Function SENSOR_DATA_TYPE_HUMAN_PROXIMITY_METERS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H2299288A, &H6D9E, &H4B0B, &HB7, &HEC, &H35, &H28, &HF8, &H9E, &H40, &HAF, 3)
 'VT_R4]
SENSOR_DATA_TYPE_HUMAN_PROXIMITY_METERS = pkk
End Function
Public Function SENSOR_DATA_TYPE_TOUCH_STATE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &H2299288A, &H6D9E, &H4B0B, &HB7, &HEC, &H35, &H28, &HF8, &H9E, &H40, &HAF, 4)
 'VT_BOOL]
SENSOR_DATA_TYPE_TOUCH_STATE = pkk
End Function
Public Function SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE4C77CE2, &HDCB7, &H46E9, &H84, &H39, &H4F, &HEC, &H54, &H88, &H33, &HA6, 2)
 'VT_R4]
SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX = pkk
End Function
Public Function SENSOR_DATA_TYPE_LIGHT_TEMPERATURE_KELVIN() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE4C77CE2, &HDCB7, &H46E9, &H84, &H39, &H4F, &HEC, &H54, &H88, &H33, &HA6, 3)
 'VT_R4]
SENSOR_DATA_TYPE_LIGHT_TEMPERATURE_KELVIN = pkk
End Function
Public Function SENSOR_DATA_TYPE_LIGHT_CHROMACITY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE4C77CE2, &HDCB7, &H46E9, &H84, &H39, &H4F, &HEC, &H54, &H88, &H33, &HA6, 4)
 'VT_VECTOR|VT_UI1]
SENSOR_DATA_TYPE_LIGHT_CHROMACITY = pkk
End Function
Public Function SENSOR_DATA_TYPE_RFID_TAG_40_BIT() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HD7A59A3C, &H3421, &H44AB, &H8D, &H3A, &H9D, &HE8, &HAB, &H6C, &H4C, &HAE, 2)
 'VT_UI8]
SENSOR_DATA_TYPE_RFID_TAG_40_BIT = pkk
End Function
Public Function SENSOR_DATA_TYPE_VOLTAGE_VOLTS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 2)
 'VT_R8]
SENSOR_DATA_TYPE_VOLTAGE_VOLTS = pkk
End Function
Public Function SENSOR_DATA_TYPE_CURRENT_AMPS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 3)
 'VT_R8]
SENSOR_DATA_TYPE_CURRENT_AMPS = pkk
End Function
Public Function SENSOR_DATA_TYPE_CAPACITANCE_FARAD() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 4)
 'VT_R8]
SENSOR_DATA_TYPE_CAPACITANCE_FARAD = pkk
End Function
Public Function SENSOR_DATA_TYPE_RESISTANCE_OHMS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 5)
 'VT_R8]
SENSOR_DATA_TYPE_RESISTANCE_OHMS = pkk
End Function
Public Function SENSOR_DATA_TYPE_INDUCTANCE_HENRY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 6)
 'VT_R8]
SENSOR_DATA_TYPE_INDUCTANCE_HENRY = pkk
End Function
Public Function SENSOR_DATA_TYPE_ELECTRICAL_POWER_WATTS() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 7)
 'VT_R8]
SENSOR_DATA_TYPE_ELECTRICAL_POWER_WATTS = pkk
End Function
Public Function SENSOR_DATA_TYPE_ELECTRICAL_PERCENT_OF_RANGE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 8)
 'VT_R8]
SENSOR_DATA_TYPE_ELECTRICAL_PERCENT_OF_RANGE = pkk
End Function
Public Function SENSOR_DATA_TYPE_ELECTRICAL_FREQUENCY_HERTZ() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HBBB246D1, &HE242, &H4780, &HA2, &HD3, &HCD, &HED, &H84, &HF3, &H58, &H42, 9)
 'VT_R8]
SENSOR_DATA_TYPE_ELECTRICAL_FREQUENCY_HERTZ = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_USAGE() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 5)
 'VT_UI4]
SENSOR_DATA_TYPE_CUSTOM_USAGE = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_BOOLEAN_ARRAY() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 6)
 'VT_UI4]
SENSOR_DATA_TYPE_CUSTOM_BOOLEAN_ARRAY = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE1() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 7)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE1 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE2() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 8)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE2 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE3() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 9)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE3 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE4() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 10)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE4 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE5() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 11)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE5 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE6() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 12)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE6 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE7() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 13)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE7 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE8() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 14)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE8 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE9() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 15)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE9 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE10() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 16)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE10 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE11() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 17)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE11 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE12() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 18)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE12 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE13() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 19)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE13 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE14() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 20)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE14 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE15() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 21)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE15 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE16() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 22)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE16 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE17() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 23)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE17 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE18() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 24)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE18 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE19() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 25)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE19 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE20() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 26)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE20 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE21() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 27)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE21 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE22() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 28)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE22 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE23() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 29)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE23 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE24() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 30)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE24 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE25() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 31)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE25 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE26() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 32)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE26 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE27() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 33)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE27 = pkk
End Function
Public Function SENSOR_DATA_TYPE_CUSTOM_VALUE28() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HB14C764F, &H7CF, &H41E8, &H9D, &H82, &HEB, &HE3, &HD0, &H77, &H6A, &H6F, 34)
 'VT_UI4||VT_R4]
SENSOR_DATA_TYPE_CUSTOM_VALUE28 = pkk
End Function
Public Function SENSOR_PROPERTY_CLEAR_ASSISTANCE_DATA() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE1E962F4, &H6E65, &H45F7, &H9C, &H36, &HD4, &H87, &HB7, &HB1, &HBD, &H34, 2)
 'VT_UI4]
SENSOR_PROPERTY_CLEAR_ASSISTANCE_DATA = pkk
End Function
Public Function SENSOR_PROPERTY_TURN_ON_OFF_NMEA() As PROPERTYKEY
Static pkk As PROPERTYKEY
 If (pkk.fmtid.Data1 = 0&) Then Call DEFINE_PROPERTYKEY(pkk, &HE1E962F4, &H6E65, &H45F7, &H9C, &H36, &HD4, &H87, &HB7, &HB1, &HBD, &H34, 3)
 'VT_UI4]
SENSOR_PROPERTY_TURN_ON_OFF_NMEA = pkk
End Function
